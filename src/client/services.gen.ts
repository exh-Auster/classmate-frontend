 ...
 * Remove Bookmarks
 */
export const removeBookmarksPostsPostIdBookmarkDelete = <ThrowOnError extends boolean = false>(options: Options<RemoveBookmarksPostsPostIdBookmarkDeleteData, ThrowOnError>) => {
    return (options?.client ?? client).delete<RemoveBookmarksPostsPostIdBookmarkDeleteResponse, RemoveBookmarksPostsPostIdBookmarkDeleteError, ThrowOnError>({
        ...options,
